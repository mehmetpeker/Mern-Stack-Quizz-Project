          ...
          <div className="flex  items-center mt-2 justify-center result">
            <div className="flex flex-col gap-2">
              <h1 className="text-2xl">SONUÇ</h1>
               <div className="divider"></div>
              <div className="marks">
                <h1 className="text-md">Toplam Soru Adedi : {examData.totalMarks}</h1>
                <h1 className="text-md">
                  Doğru cevap :{result.correctAnswers.length}
                </h1>
                <h1 className="text-md">
                  Yanlış Cevap : {result.wrongAnswers.length}
                </h1>
                <h1 className="text-md">
                  Geçer Soru Adedi : {examData.passingMarks}
                </h1>
                <h1 className="text-md">Sonuç :{result.verdict}</h1>
            ...
            {questions.map((question, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h1 className="text-md">
                    Verilen Yanıt : {selectedOptions[index]} -{" "}
                    {question.options[selectedOptions[index]]}
                  </h1>
                  <h1 className="text-md">
                    Doğru Yanıt : {question.correctOption} -{" "}
