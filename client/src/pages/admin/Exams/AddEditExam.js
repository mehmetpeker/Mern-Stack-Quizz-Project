...
function AddEditExam() {
  ...
  return (
    <div>
      <PageTitle title={params.id ? "Sınavı Düzenle" : "Sınav Ekle"} />
          ...
          <Tabs defaultActiveKey="1">
            <TabPane tab="Sınav Detayları" key="1">
              <Row gutter={[10, 10]}>
                ...
                <Col span={8}>
                  <Form.Item label="Sınav Süresi" name="duration">
                    <input type="number" />
                  </Form.Item>
                </Col>
                <Col span={8}>
                ...
                <Col span={8}>
                  <Form.Item label="Toplam Soru Sayısı" name="totalMarks">
                    <input type="number" />
                  </Form.Item>
                </Col>
                <Col span={8}>
                  <Form.Item label="Geçer Soru Sayısı" name="passingMarks">
                    <input type="number" />
                  </Form.Item>
                </Col>
              </Row>
